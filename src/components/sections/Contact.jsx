...
const Contact = () => {
  return (
    <div className='w-full min-h-screen flex flex-col px-6 md:px-20' id='contact'>
      ...
      <div className='w-full h-full flex flex-col md:flex-row items-center gap-10 mt-10 justify-center'>
        ...
        className="flex items-center gap-2 bg-sky-100 dark:bg-gray-800 p-4 rounded-lg shadow-lg 
        ...
        >
          ...
          <span className="font-medium text-gray-800 dark:text-white">+92 300 1234567</span>
        </a>
        <div className="flex items-center gap-2 bg-sky-100 dark:bg-gray-800 p-4 rounded-lg shadow-lg">
      ...
      {/* Contact form */}
      <form className='w-full max-w-2xl mx-auto my-10 flex flex-col gap-6 bg-sky-50 dark:bg-gray-800 p-6 rounded-lg shadow-lg'>
